...
public class ConvertorLogic {
	...
	private static Map<Character,Integer> RepeatableLiteralsCount = getRepeatableRomanCount();

	private static Map<Character,Integer> getRepeatableRomanCount(){
		Map<Character,Integer>map = new HashMap<Character,Integer>() {
			/**
			 * 
			 */
			private static final long serialVersionUID = -2966262945441929619L;
	...
	private static Map<Character,Integer> NonRepeatableLiteralsCount = getNonRepeatableRomanCount();

	private static Map<Character,Integer> getNonRepeatableRomanCount(){
		Map<Character,Integer>map = new HashMap<Character,Integer>() {
			/**
			 * 
			 */
			private static final long serialVersionUID = 4033070672035944558L;
	...
	private static Map<Integer, Integer[]> ROMAN_SUBTRACTABLE_MAPPING = Collections.unmodifiableMap(
			new HashMap<Integer, Integer[]>() {
				 ...
				 * 
				 */
				private static final long serialVersionUID = 5485428641249607004L;
	...
	private static Map<Character, Integer> ROMAN_TO_NUMERIC_MAPPING = Collections.unmodifiableMap(
			new HashMap<Character, Integer>() {
				 ...
				 * 
				 */
				private static final long serialVersionUID = -4269527099463669980L;
	...
	public static void resetLiteralsCounter(){
		RepeatableLiteralsCount = getRepeatableRomanCount();
		NonRepeatableLiteralsCount = getNonRepeatableRomanCount();
